...
plt.subplot(2,1,1)
mel_filter_freq = librosa.filters.mel(sr=16000, n_fft=400, n_mels=40).T
plt.plot(mel_filter_freq)

plt.title("40-band Mel filterbank")
...
plt.plot(gammatone_filter_freq)
