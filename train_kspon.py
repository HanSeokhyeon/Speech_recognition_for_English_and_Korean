...
parser = argparse.ArgumentParser(description='Training script for LAS on Kspon')
...
# Load preprocessed Kspon Dataset (using testing set directly here, replace them with validation set your self)
