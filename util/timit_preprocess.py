...
print(
    'Collected {} training instances from {} (should be 4620 in complete TIMIT )'.format(train_size, train_source_path))
print(
    'Collected {} testing instances from {} (should be 1680 in complete TIMIT )'.format(len(X_test), test_source_path))

print('Spliting {} out of {} ({}%) training data as validation set.'.format(int(train_size * val_split), train_size,
                                                                            val_split * 100))
